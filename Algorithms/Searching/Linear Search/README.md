...
It gets dismissed as the "slow" option, but that framing misses the point. Linear search shines precisely in situations where [Binary Search](Algorithms/Searching/Binary%20Search/README.md) can't even start.
...
- The array is already **sorted** — use [Binary Search](Algorithms/Searching/Binary%20Search/README.md)
...
| <input type="checkbox" checked id="969c99">   | [275. H-Index II](https://leetcode.com/problems/h-index-ii/)                                                            | **Medium** | [Watch Video](https://www.youtube.com/watch?v=m5igTaeo9Ik) |
